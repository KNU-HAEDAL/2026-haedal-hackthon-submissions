...
- **base** repository: `HJTN/2026-haedal-hackton-submissions`
- base branch: `main`
- **head** repository: `yourID/2026-haedal-hackton-submissions`
- compare branch: `main`
...
## 통과 확인
PR을 올리면 GitHub Actions가 자동으로 10개 파일이 모두 제출되었는지 확인합니다.  
모두 통과되면 ✅ 체크가 표시됩니다.
